...
/* Smarty version 4.2.1, created on 2023-02-10 11:18:07
  from '/home/u704205129/domains/piasat.com/public_html/modules/tvcmscustomsetting/views/templates/front/display_custom_social.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63e627ef78d314_74810489',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3f55de77632c15c9723ea648d605cb3e9465684b' => 
    array (
      0 => '/home/u704205129/domains/piasat.com/public_html/modules/tvcmscustomsetting/views/templates/front/display_custom_social.tpl',
      1 => 1674084821,
      2 => 'file',
    ),
  ),
...
function content_63e627ef78d314_74810489 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
?>
    <?php if ($_smarty_tpl->tpl_vars['LeftStickyStatus']->value) {
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_92263926863e627ef774dc1_18406696', 'block_social');
}
if ($_smarty_tpl->tpl_vars['RightStickyStatus']->value) {?><div class="tvcmsright-sticky wow slideInRight"><div class="tvright-sticky"><div class="tvright-sticky-wrapper"><div class="cart-preview"><div class="tvright-sticky-add-to-cart"><a href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['urls']->value['pages']['cart'], ENT_QUOTES, 'UTF-8');?>
...
</span></a></div></div><div class="tvright-sticky-account"><a class="logout" href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['urls']->value['pages']['my_account'], ENT_QUOTES, 'UTF-8');?>
...
/* {block 'block_social'} */
class Block_92263926863e627ef774dc1_18406696 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'block_social' => 
  array (
    0 => 'Block_92263926863e627ef774dc1_18406696',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="block-social tv-footer-social-icon wow slideInLeft"><div class="tv-footer-social-icon-wrapper"><div class="tv-footer-social-icon-inner"><?php if (!empty(Configuration::get('BLOCKSOCIAL_FACEBOOK',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvfacebook-wrapper"><a href="<?php echo htmlspecialchars((string) Configuration::get('BLOCKSOCIAL_FACEBOOK, $language.id'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_TWITTER',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvtwitter-wrapper"><a href="<?php echo htmlspecialchars((string) Configuration::get('BLOCKSOCIAL_TWITTER, $language.id'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_RSS',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvrss-wrapper"><a href="<?php echo htmlspecialchars((string) Configuration::get('BLOCKSOCIAL_RSS, $language.id'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_YOUTUBE',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvyoutube-wrapper"><a href="<?php echo htmlspecialchars((string) Configuration::get('BLOCKSOCIAL_YOUTUBE, $language.id'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_PINTEREST',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvpinterest-wrapper"><a href="<?php echo htmlspecialchars((string) Configuration::get('BLOCKSOCIAL_PINTEREST, $language.id'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_VIMEO',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvvimeo-wrapper"><a href="<?php echo htmlspecialchars((string) Configuration::get('BLOCKSOCIAL_VIMEO, $language.id'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_INSTAGRAM',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvinstagram-wrapper"><a href="<?php echo htmlspecialchars((string) Configuration::get('BLOCKSOCIAL_INSTAGRAM, $language.id'), ENT_QUOTES, 'UTF-8');?>
