...
/* Smarty version 4.2.1, created on 2023-02-10 11:26:21
  from '/home/u704205129/domains/piasat.com/public_html/modules/tvcmsnewproducts/views/templates/front/display_home-data.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63e629dd4bdbc0_24984209',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'faa011e267297a66a32e9c741c43c3f8be0751ca' => 
    array (
      0 => '/home/u704205129/domains/piasat.com/public_html/modules/tvcmsnewproducts/views/templates/front/display_home-data.tpl',
      1 => 1674084821,
      2 => 'file',
    ),
  ),
...
function content_63e629dd4bdbc0_24984209 (Smarty_Internal_Template $_smarty_tpl) {
...
?></div><div class='tvall-product-offer-banner'><?php if ($_smarty_tpl->tpl_vars['image']->value == true && $_smarty_tpl->tpl_vars['image_side']->value == 'left') {?><div class="tvall-product-branner col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="tvbanner-hover-wrapper tvall-block-box-shadows"><div class="tvbranner-hover-info-box"></div><div class='tvbanner-hover'></div><img src="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['dis_arr_result']->value['path'], ENT_QUOTES, 'UTF-8');
...
" class="tv-img-responsive" loading="lazy"/><div class='tvbanner-hover1'></div></div></div><?php }?><div class="tvnew-product-content <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['col']->value, ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div></div></div></div><?php if ($_smarty_tpl->tpl_vars['image']->value == true && $_smarty_tpl->tpl_vars['image_side']->value == 'right') {?><div class="tvall-product-branner col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="tvbanner-hover-wrapper tvall-block-box-shadows"><div class="tvbranner-hover-info-box"></div><div class='tvbanner-hover'></div><img src="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['dis_arr_result']->value['path'], ENT_QUOTES, 'UTF-8');
echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['main_heading']->value['data']['image'], ENT_QUOTES, 'UTF-8');?>
" alt="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'new Offer Banner','mod'=>'tvcmsnewproducts'),$_smarty_tpl ) );?>
"  width="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['main_heading']->value['data']['width'], ENT_QUOTES, 'UTF-8');?>
" height="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['main_heading']->value['data']['height'], ENT_QUOTES, 'UTF-8');?>
" class="tv-img-responsive"loading="lazy" /><div class='tvbanner-hover1'></div></div></div><?php }?><div class='tvnew-pagination-wrapper tv-pagination-wrapper'><div class="tvnew-pagination"><div class="tvcmsnew-pagination"><div class="tvcmsnew-next-pre-btn tvcms-next-pre-btn"><div class="tvcmsnew-prev tvcmsprev-btn" data-parent="tvcmsnew-product"><i class='material-icons'>&#xe314;</i></div><div class="tvcmsnew-next tvcmsnext-btn" data-parent="tvcmsnew-product"><i class='material-icons'>&#xe315;</i></div></div></div></div></div><div class="tvallproduct-link"><a class="all-product-link" href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['dis_arr_result']->value['link'], ENT_QUOTES, 'UTF-8');?>
