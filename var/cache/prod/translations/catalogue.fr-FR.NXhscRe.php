...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'Item' => 'Article',
    'Items' => 'Articles',
    'No product add in cart' => 'Aucun produit ajouté au panier',
...
',
  ...
  array (
    ...
    'Webservice status' => 'Statut du service web',
    'Webservice is enabled. Main entry point is' => 'Le service web est activé. Le point d\'entrée principal est',
    'It seems that the webservice endpoint is not functional. If you are using httpd/apache2, you need to enable URL rewriting on your server.' => 'Il semble que le point de terminaison du service Web ne soit pas fonctionnel. Si vous utilisez httpd/apache2, vous devez activer la réécriture d\'URL sur votre serveur.',
  ...
  array (
    ...
    'Search our catalog' => 'Rechercher dans notre catalogue',
    'Search' => 'Rechercher',
...
',
  ...
  array (
    ...
    'Please activate the \'mod_auth_basic\' Apache module to allow the use of the PrestaShop webservice.' => 'Veuillez activer le module Apache \'mod_auth_basic\' pour permettre l\'utilisation du service web PrestaShop.',
    'We could not check to see if basic authentication and rewrite extensions have been activated. Please manually check if they\'ve been activated in order to use the PrestaShop webservice.' => 'Nous n\'avons pas pu vérifier si l\'authentification de base et la réécritures des extensions sont activés. Veuillez vérifier si elles sont activées afin de pouvoir utiliser le web service PrestaShop.',
    'Please activate the \'SimpleXML\' PHP extension to allow testing of PrestaShop\'s webservice.' => 'Vous devez activer l\'extension PHP "SimpleXML" afin de permettre les tests du web service PrestaShop.',
    'It is preferable to use SSL (https:) for webservice calls, as it avoids the "man in the middle" type security issues.' => 'Il est préférable d\'utiliser le protocole SSL (https) pour les appels web service, car il évite les problèmes de sécurité de type "man in the middle".',
