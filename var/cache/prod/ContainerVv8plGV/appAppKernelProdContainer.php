...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QXS43TEVJP', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'u704205129_1IpCf', 'user' => 'u704205129_X4Eu3', 'password' => '4gzNHg84sy', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setNamingStrategy(($this->services['prestashop.database.naming_strategy'] ?? ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('bltk_'))));
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('bltk_');
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TC9frJjsXn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('y3wu6D5AR52I7SjZesiDyallVYcDAHpPNCq1kYqwBQ8D5GTITdXHK1cy'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                60 => 'ps_facetedsearch',
                61 => 'tvcmsbestsellerproducts',
                62 => 'tvcmsblog',
                63 => 'tvcmsblogdisplayposts',
                64 => 'tvcmsbrandlist',
                65 => 'tvcmscategorychainslider',
                66 => 'tvcmscategoryproduct',
                67 => 'tvcmscategoryslider',
                68 => 'tvcmscookiesnotice',
                69 => 'tvcmscustomcssjs',
                70 => 'tvcmscustomerservices',
                71 => 'tvcmscustomsetting',
                72 => 'tvcmsfeaturedproducts',
                73 => 'tvcmsfooterlogo',
                74 => 'tvcmsfooterproduct',
                75 => 'tvcmsinfinitescroll',
                76 => 'tvcmsmegamenu',
                77 => 'tvcmsmultibanner1',
                78 => 'tvcmsnewproducts',
                79 => 'tvcmsnewsletterpopup',
                80 => 'tvcmsofferbanner',
                81 => 'tvcmspaymenticon',
                82 => 'tvcmsproductcomments',
                83 => 'tvcmsproductcompare',
                84 => 'tvcmsproductpopup',
                85 => 'tvcmssearch',
                86 => 'tvcmssingleblock',
                87 => 'tvcmssizechart',
                88 => 'tvcmsslider',
                89 => 'tvcmssliderofferbanner',
                90 => 'tvcmsspecialproducts',
                91 => 'tvcmsstockinfo',
                92 => 'tvcmstabproducts',
                93 => 'tvcmstestimonial',
                94 => 'tvcmsthemeoptions',
                95 => 'tvcmstwoofferbanner',
                96 => 'tvcmsverticalmenu',
                97 => 'tvcmsvideotab',
                98 => 'tvcmswishlist',
                99 => 'seoaltimages',
                100 => 'prettyurls',
            ...
            'modules_translation_paths' => [
                ...
                20 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                ...
                42 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/ps_viewedproduct/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                ...
                50 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/tvcmsbestsellerproducts/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/tvcmsblog/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/tvcmsblogdisplayposts/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/tvcmsbrandlist/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/tvcmscategorychainslider/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/tvcmscategoryproduct/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/tvcmscategoryslider/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/tvcmscookiesnotice/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/tvcmscustomcssjs/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/tvcmscustomerservices/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/tvcmscustomsetting/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/tvcmsfeaturedproducts/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/tvcmsfooterlogo/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/tvcmsfooterproduct/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/tvcmsinfinitescroll/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/tvcmsmegamenu/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/tvcmsmultibanner1/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/tvcmsnewproducts/translations'),
                72 => (\dirname(__DIR__, 4).'/modules/tvcmsnewsletterpopup/translations'),
                73 => (\dirname(__DIR__, 4).'/modules/tvcmsofferbanner/translations'),
                74 => (\dirname(__DIR__, 4).'/modules/tvcmspaymenticon/translations'),
                75 => (\dirname(__DIR__, 4).'/modules/tvcmsproductcomments/translations'),
                76 => (\dirname(__DIR__, 4).'/modules/tvcmsproductcompare/translations'),
                77 => (\dirname(__DIR__, 4).'/modules/tvcmsproductpopup/translations'),
                78 => (\dirname(__DIR__, 4).'/modules/tvcmssearch/translations'),
                79 => (\dirname(__DIR__, 4).'/modules/tvcmssingleblock/translations'),
                80 => (\dirname(__DIR__, 4).'/modules/tvcmssizechart/translations'),
                81 => (\dirname(__DIR__, 4).'/modules/tvcmsslider/translations'),
                82 => (\dirname(__DIR__, 4).'/modules/tvcmssliderofferbanner/translations'),
                83 => (\dirname(__DIR__, 4).'/modules/tvcmsspecialproducts/translations'),
                84 => (\dirname(__DIR__, 4).'/modules/tvcmsstockinfo/translations'),
                85 => (\dirname(__DIR__, 4).'/modules/tvcmstabproducts/translations'),
                86 => (\dirname(__DIR__, 4).'/modules/tvcmstestimonial/translations'),
                87 => (\dirname(__DIR__, 4).'/modules/tvcmsthemeoptions/translations'),
                88 => (\dirname(__DIR__, 4).'/modules/tvcmstwoofferbanner/translations'),
                89 => (\dirname(__DIR__, 4).'/modules/tvcmsverticalmenu/translations'),
                90 => (\dirname(__DIR__, 4).'/modules/tvcmsvideotab/translations'),
                91 => (\dirname(__DIR__, 4).'/modules/tvcmswishlist/translations'),
                92 => (\dirname(__DIR__, 4).'/modules/prettyurls/translations'),
            ],
            ...
            'kernel.secret' => 'y3wu6D5AR52I7SjZesiDyallVYcDAHpPNCq1kYqwBQ8D5GTITdXHK1cy',
