...
{if $input.type == 'BtnInstallData'}
        ...
        <button class="btn btn-primary tvcms-sample-install-btn float-right" type="submit" onclick="return confirmAction()" name="submitTvcmsSampleinstall">{l s='Install Sample Data' mod="tvcmsleftsideofferbanner"}</button>
{/if}
