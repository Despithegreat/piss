...
{if $input.type == 'BtnInstallData'}
            ...
            <button class="btn btn-primary tvcms-sample-install-btn" type="submit" onclick="return confirmAction()" name="submitTvcmsSampleinstall">{l s='Install Sample Data' mod="tvcmssliderofferbanner"}</button>
    {/if}
    {if $input.type == 'file_upload'}
        <div class="col-lg-9">
                    ...
                    <div class="dummyfile input-group">
                        ...
                        <span class="input-group-btn">
                            <button id="{$input.name|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
                                <i class="icon-folder-open"></i> {l s='Choose a file' mod='tvcmssliderofferbanner'}
                            </button>
                        </span>
                    </div>
                </div>
            ...
            {assign var='width' value='229'}
            {assign var='height' value='234'}
            <div class="form-group">
