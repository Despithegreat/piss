...
class Skrill extends PaymentModule
{
    ...
    protected $supportedLanguages = ['en', 'de', 'it', 'es', 'fr', 'pl'];
    protected $paymentMethodShowTitleLogo = [];
    ...
    public function __construct()
    {
        ...
        $this->paymentMethodShowTitleLogo = ['ADB', 'AOB', 'ACI'];
    ...
    protected function processUpdatedOrder($orderId, $trasanctionLog, $redirect = true)
    {
        ...
        $messageLog = 'Skrill - update order response : ' . base64_encode($paymentResponse);
        PrestaShopLogger::addLog($messageLog, 1, null, 'Order', $orderId, true);
    ...
    public function mailAlert($order, $paymentBrand, $status, $template)
    {
        if (!Module::isInstalled('mailalerts')) {
            ...
            $templateVars = [
                ...
                '{delivery_block_html}' => SkrillCustomMailAlert::getFormatedAddress($delivery, '<br />', [
                'firstname' => '<span style="color:blue; font-weight:bold;">%s</span>',
                'lastname' => '<span style="color:blue; font-weight:bold;">%s</span>', ]),
                '{invoice_block_html}' => SkrillCustomMailAlert::getFormatedAddress($invoice, '<br />', [
                'firstname' => '<span style="color:blue; font-weight:bold;">%s</span>',
                'lastname' => '<span style="color:blue; font-weight:bold;">%s</span>', ]),
                ...
                '{delivery_state}' => $deliveryState ? $deliveryState->name : '',
                ...
                '{invoice_state}' => $invoiceState ? $invoiceState->name : '',
